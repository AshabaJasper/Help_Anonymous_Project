...
class _DailyQuizWidgetState extends State<DailyQuizWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DailyQuizModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'DailyQuiz'});
    setupAnimations(
                                  ...
                                  child: Padding(
                                    ...
                                    child: FlutterFlowCheckboxGroup(
                                      ...
                                      onChanged: (val) async {
                                        ...
                                        logFirebaseEvent(
                                            'DAILY_QUIZ_CheckboxGroup_i9g1enpj_ON_FOR');
                                        logFirebaseEvent(
                ...
                children: [
                  Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        logFirebaseEvent(
                            'DAILY_QUIZ_PAGE_NEXT_QUESTION_BTN_ON_TAP');
